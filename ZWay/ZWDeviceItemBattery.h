...
@interface ZWDeviceItemBattery : ZWDeviceItem

@property (strong, nonatomic) IBOutlet UILabel *scale;
@property (strong, nonatomic) IBOutlet UILabel *valueView;
